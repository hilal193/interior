    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 project-details-left">
                ...
                <img class="img-fluid" src={{ asset('img/'. $articleTout->url) }} alt="">
            </div>
            <div class="col-lg-6 project-details-right">
                {{-- <h3 class="pb-20">Lavendar ambient interior</h3> --}}
                <h3 class="pb-20">{{ $articleTout->titre }}</h3>
                <p>
                    {{-- {{ str_limit($projetTout->nextPost()['titre'], 10) }} --}}

                    Petite description : {{ Str::limit($articleTout->description, 50) }}
                ...
                <div class="details-info d-flex flex-row">
                    ...
                    <ul class="desc">
                        <li>: {{ $articleTout->auteur }}</li>
                        <li>: {{ $articleTout->creation }}</li>
                    </ul>
                </div>
            </div>
